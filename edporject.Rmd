...
\
Our experimental units are PCs, which have taken from The following Labs Ishango, Scilab and MiddleTr. Due to the differences in specifications in the PCs, we have decided to block for the labs, to reduce experimental error variance between the experiment units. We've selected 3 PCs from each lab (randomly).  So we have ( experimental units in total. 
