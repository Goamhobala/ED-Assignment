...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{skeleton_files/tableTukey} \caption{Results of Tukey's Honestly Significance Difference Test. Values Greater than HSD are Highlighted in Blue}\label{fig:tableTukey}
\end{figure}
