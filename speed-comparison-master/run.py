...
if __name__ == "__main__":
    ...
    subprocess.run(["pwd"])
    subprocess.run(["mv", "C:\cygwin64\home\Student\ED-Assignment\speed-comparison-master/results/*", "C:\cygwin64\home\Student\ED-Assignment\speed-comparison-master/data/scilabB/fifteen30"])
