...
```{r, tableAnova, tableAnova.cap="The ANOVA table", results='asis'}
setwd("./speed-comparison-master/data/")
...
```
We verified our assumptions by performing Shapiro Wilk test on the residuals. We obtained a p-value of 0.2531, indicating that there is little evidence that the residuals are not normally distributed. Further, we also got that the mean of the residuals is less than 0.0001, indicating that it is safe to assume $e_{ij} \sim \mathcal{N}(0, \sigma^2)$ 
